...
_lr_productions = [
  ...
  ('expression -> term','expression',1,'p_expression_term','prbs.py',10),
  ('expression -> datos declaracion','expression',2,'p_expression_decl','prbs.py',13),
  ('expression -> declaracion','expression',1,'p_expression_decl','prbs.py',14),
  ('expression -> expression opmat term','expression',3,'p_expression_opermat','prbs.py',19),
  ('expression -> condicional','expression',1,'p_expression_condicion','prbs.py',24),
  ('expression -> expresionlogic','expression',1,'p_expression_logic','prbs.py',29),
  ('expression -> expresionlogic connectlog expresionlogic','expression',3,'p_expression_logic','prbs.py',30),
  ('expresionlogic -> term oplog term','expresionlogic',3,'p_expresionlogic_rel','prbs.py',35),
  ('expresionlogic -> TRUE','expresionlogic',1,'p_expresionlogic_bool','prbs.py',38),
  ('expresionlogic -> FALSE','expresionlogic',1,'p_expresionlogic_bool','prbs.py',39),
  ('expression -> VARIABLE assignacion SEMICOLON','expression',3,'p_expression_preop','prbs.py',42),
  ('expression -> assignacion VARIABLE SEMICOLON','expression',3,'p_expression_postop','prbs.py',47),
  ('oper -> VARIABLE assignacion','oper',2,'p_preop','prbs.py',52),
  ('oper -> assignacion VARIABLE','oper',2,'p_postop','prbs.py',55),
  ('expression -> WHILE condicional LBRACKET expression RBRACKET','expression',5,'p_expression_while','prbs.py',59),
  ('expression -> FOR LPAREN datos declaracion expresionlogic SEMICOLON oper RPAREN LBRACKET expression RBRACKET','expression',11,'p_expression_for','prbs.py',64),
  ('expression -> IF condicional LBRACKET expression RBRACKET','expression',5,'p_expression_if','prbs.py',69),
  ('condicional -> LPAREN expresionlogic RPAREN','condicional',3,'p_condicional','prbs.py',75),
  ('declaracion -> VARIABLE ASSIGNMENT expression SEMICOLON','declaracion',4,'p_declaracion','prbs.py',78),
  ('connectlog -> AND','connectlog',1,'p_connectlog','prbs.py',81),
  ('connectlog -> OR','connectlog',1,'p_connectlog','prbs.py',82),
  ('oplog -> EQUAL','oplog',1,'p_oplog','prbs.py',86),
  ('oplog -> NOTEQUAL','oplog',1,'p_oplog','prbs.py',87),
  ('oplog -> GREATERTHAN','oplog',1,'p_oplog','prbs.py',88),
  ('oplog -> GREATERTHANEQUAL','oplog',1,'p_oplog','prbs.py',89),
  ('oplog -> LESSERTHAN','oplog',1,'p_oplog','prbs.py',90),
  ('oplog -> LESSERTHANEQUAL','oplog',1,'p_oplog','prbs.py',91),
  ('opmat -> PLUS','opmat',1,'p_opmat','prbs.py',95),
  ('opmat -> MINUS','opmat',1,'p_opmat','prbs.py',96),
  ('opmat -> TIMES','opmat',1,'p_opmat','prbs.py',97),
  ('opmat -> DIVIDE','opmat',1,'p_opmat','prbs.py',98),
  ('opmat -> MOD','opmat',1,'p_opmat','prbs.py',99),
  ('assignacion -> INCREMENT','assignacion',1,'p_assignacion','prbs.py',103),
  ('assignacion -> DECREMENT','assignacion',1,'p_assignacion','prbs.py',104),
  ('assignacion -> COMPASSIGPLUS','assignacion',1,'p_assignacion','prbs.py',105),
  ('assignacion -> COMPASSIGMINUS','assignacion',1,'p_assignacion','prbs.py',106),
  ('assignacion -> COMPASSIGTIMES','assignacion',1,'p_assignacion','prbs.py',107),
  ('assignacion -> COMPASSIGDIVIDE','assignacion',1,'p_assignacion','prbs.py',108),
  ('term -> factor','term',1,'p_term_factor','prbs.py',112),
  ('factor -> VARIABLE','factor',1,'p_factor_var','prbs.py',115),
  ('term -> NUMBER','term',1,'p_term_numero','prbs.py',119),
  ('datos -> BOOL','datos',1,'p_datos','prbs.py',129),
  ('datos -> BYTE','datos',1,'p_datos','prbs.py',130),
  ('datos -> CHAR','datos',1,'p_datos','prbs.py',131),
  ('datos -> DECIMAL','datos',1,'p_datos','prbs.py',132),
  ('datos -> DOUBLE','datos',1,'p_datos','prbs.py',133),
  ('datos -> FLOAT','datos',1,'p_datos','prbs.py',134),
  ('datos -> INT','datos',1,'p_datos','prbs.py',135),
  ('datos -> LONG','datos',1,'p_datos','prbs.py',136),
  ('datos -> SBYTE','datos',1,'p_datos','prbs.py',137),
  ('datos -> SHORT','datos',1,'p_datos','prbs.py',138),
  ('datos -> UINT','datos',1,'p_datos','prbs.py',139),
  ('datos -> ULONG','datos',1,'p_datos','prbs.py',140),
  ('datos -> USHORT','datos',1,'p_datos','prbs.py',141),
]
