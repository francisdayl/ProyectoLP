...
_lr_productions = [
  ...
  ('expression -> term','expression',1,'p_expression_term','funciones_sintact.py',10),
  ('expression -> datos declaracion','expression',2,'p_expression_decl','funciones_sintact.py',13),
  ('expression -> declaracion','expression',1,'p_expression_decl','funciones_sintact.py',14),
  ('expression -> expression opmat term','expression',3,'p_expression_opermat','funciones_sintact.py',19),
  ('expression -> condicional','expression',1,'p_expression_condicion','funciones_sintact.py',24),
  ('expression -> expresionlogic','expression',1,'p_expression_logic','funciones_sintact.py',29),
  ('expression -> expresionlogic connectlog expresionlogic','expression',3,'p_expression_logic','funciones_sintact.py',30),
  ('expresionlogic -> term oplog term','expresionlogic',3,'p_expresionlogic_rel','funciones_sintact.py',35),
  ('expresionlogic -> TRUE','expresionlogic',1,'p_expresionlogic_bool','funciones_sintact.py',38),
  ('expresionlogic -> FALSE','expresionlogic',1,'p_expresionlogic_bool','funciones_sintact.py',39),
  ('expression -> VARIABLE assignacion SEMICOLON','expression',3,'p_expression_preop','funciones_sintact.py',42),
  ('expression -> assignacion VARIABLE SEMICOLON','expression',3,'p_expression_postop','funciones_sintact.py',47),
  ('oper -> VARIABLE assignacion','oper',2,'p_preop','funciones_sintact.py',52),
  ('oper -> assignacion VARIABLE','oper',2,'p_postop','funciones_sintact.py',55),
  ('expression -> WHILE condicional LBRACKET expression RBRACKET','expression',5,'p_expression_while','funciones_sintact.py',59),
  ('expression -> FOR LPAREN datos declaracion expresionlogic SEMICOLON oper RPAREN LBRACKET expression RBRACKET','expression',11,'p_expression_for','funciones_sintact.py',64),
  ('expression -> IF condicional LBRACKET expression RBRACKET','expression',5,'p_expression_if','funciones_sintact.py',69),
  ('condicional -> LPAREN expresionlogic RPAREN','condicional',3,'p_condicional','funciones_sintact.py',75),
  ('declaracion -> VARIABLE ASSIGNMENT expression SEMICOLON','declaracion',4,'p_declaracion','funciones_sintact.py',78),
  ('connectlog -> AND','connectlog',1,'p_connectlog','funciones_sintact.py',81),
  ('connectlog -> OR','connectlog',1,'p_connectlog','funciones_sintact.py',82),
  ('oplog -> EQUAL','oplog',1,'p_oplog','funciones_sintact.py',86),
  ('oplog -> NOTEQUAL','oplog',1,'p_oplog','funciones_sintact.py',87),
  ('oplog -> GREATERTHAN','oplog',1,'p_oplog','funciones_sintact.py',88),
  ('oplog -> GREATERTHANEQUAL','oplog',1,'p_oplog','funciones_sintact.py',89),
  ('oplog -> LESSERTHAN','oplog',1,'p_oplog','funciones_sintact.py',90),
  ('oplog -> LESSERTHANEQUAL','oplog',1,'p_oplog','funciones_sintact.py',91),
  ('opmat -> PLUS','opmat',1,'p_opmat','funciones_sintact.py',95),
  ('opmat -> MINUS','opmat',1,'p_opmat','funciones_sintact.py',96),
  ('opmat -> TIMES','opmat',1,'p_opmat','funciones_sintact.py',97),
  ('opmat -> DIVIDE','opmat',1,'p_opmat','funciones_sintact.py',98),
  ('opmat -> MOD','opmat',1,'p_opmat','funciones_sintact.py',99),
  ('assignacion -> INCREMENT','assignacion',1,'p_assignacion','funciones_sintact.py',103),
  ('assignacion -> DECREMENT','assignacion',1,'p_assignacion','funciones_sintact.py',104),
  ('assignacion -> COMPASSIGPLUS','assignacion',1,'p_assignacion','funciones_sintact.py',105),
  ('assignacion -> COMPASSIGMINUS','assignacion',1,'p_assignacion','funciones_sintact.py',106),
  ('assignacion -> COMPASSIGTIMES','assignacion',1,'p_assignacion','funciones_sintact.py',107),
  ('assignacion -> COMPASSIGDIVIDE','assignacion',1,'p_assignacion','funciones_sintact.py',108),
  ('term -> factor','term',1,'p_term_factor','funciones_sintact.py',112),
  ('factor -> VARIABLE','factor',1,'p_factor_var','funciones_sintact.py',115),
  ('term -> NUMBER','term',1,'p_term_numero','funciones_sintact.py',119),
  ('datos -> BOOL','datos',1,'p_datos','funciones_sintact.py',129),
  ('datos -> BYTE','datos',1,'p_datos','funciones_sintact.py',130),
  ('datos -> CHAR','datos',1,'p_datos','funciones_sintact.py',131),
  ('datos -> DECIMAL','datos',1,'p_datos','funciones_sintact.py',132),
  ('datos -> DOUBLE','datos',1,'p_datos','funciones_sintact.py',133),
  ('datos -> FLOAT','datos',1,'p_datos','funciones_sintact.py',134),
  ('datos -> INT','datos',1,'p_datos','funciones_sintact.py',135),
  ('datos -> LONG','datos',1,'p_datos','funciones_sintact.py',136),
  ('datos -> SBYTE','datos',1,'p_datos','funciones_sintact.py',137),
  ('datos -> SHORT','datos',1,'p_datos','funciones_sintact.py',138),
  ('datos -> UINT','datos',1,'p_datos','funciones_sintact.py',139),
  ('datos -> ULONG','datos',1,'p_datos','funciones_sintact.py',140),
  ('datos -> USHORT','datos',1,'p_datos','funciones_sintact.py',141),
]
